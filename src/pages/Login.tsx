    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <Link to="/register" className="font-medium text-[#5552dd] hover:text-[#4543bb]">
            Regístrate aquí
          </Link>
        </p>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className={`block w-full pl-10 sm:text-sm rounded-md focus:ring-[#5552dd] focus:border-[#5552dd] p-2.5 ${
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-[#5552dd] hover:text-[#4543bb]">
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#5552dd] hover:bg-[#4543bb] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#5552dd] disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
              >
                {loading ? (
